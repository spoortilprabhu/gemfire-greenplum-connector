...
start server --name=s1 --cache-xml-file=server-cache.xml --include-system-classpath --classpath=/C:/Users/Administrator/Desktop/GemfireGreenplumConnectorDemo/gemfire-greenplum-4.0.1.jar.jar
